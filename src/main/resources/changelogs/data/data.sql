...
values
    ('Krzysztof', '1994-12-26', 2, 'man', 'woman', 'https://upload.wikimedia.org/wikipedia/commons/0/0a/Krzysztof_Kononowicz_w_2000.jpg', 'My name is Krzyszof, Im from Białystok.',50.0);
insert into users
...
INSERT INTO user_info
    (first_name, date_of_birth, location_id, gender_identity, gender_interest, url, about, max_distance)
VALUES
    ('Ala', '1990-08-15', 1, 'woman', 'man', 'https://cdn.britannica.com/35/238335-050-2CB2EB8A/Lionel-Messi-Argentina-Netherlands-World-Cup-Qatar-2022.jpg', 'I like watch netflix.',60.0);
insert into users
    (email, password, user_role_id, user_info_id)
values
...
insert into user_info
    (first_name, date_of_birth, location_id, gender_identity, gender_interest, url, about, max_distance)
values
    ('Jakub', '1996-12-26', 3, 'man', 'woman', 'https://s3.party.pl/newsy/quebonafide-czego-o-nim-nie-wiecie-485687-4_3_800.jpg', 'Im Jakub, I like dance and playing football.',100.0);
insert into users
    (email, password, user_role_id, user_info_id)
values
...
INSERT INTO user_info
    (first_name, date_of_birth, location_id, gender_identity, gender_interest, url, about, max_distance)
VALUES
    ('Ola', '1990-08-15', 4, 'woman', 'man', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQHXCaI3sS-7XvMtZvdbSuVjDd6zlSYNbU-HDCF6bZl6Gq1jSNIV2VDOQ8DAxAe11VsJDA&usqp=CAU', 'Opis Anny',10000.0);
insert into users
    (email, password, user_role_id, user_info_id)
values
...
INSERT INTO user_info
    (first_name, date_of_birth, location_id, gender_identity, gender_interest, url, about, max_distance)
VALUES
    ('Stanisław', '1990-08-15', 1, 'man', 'woman', 'https://static.wirtualnemedia.pl/media/top/MaxKolonko655.png', 'I like running',50.0);
insert into users
    (email, password, user_role_id, user_info_id)
values
